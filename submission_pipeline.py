...
Original file is located at
    https://colab.research.google.com/drive/1Isf_6xLpc3kBte7eT-VNqzGdhEhhrP2A
"""
...
!kaggle datasets download -d bipulnath98/fake-news-dataset-for-machine-learning

!unzip /content/fake-news-dataset-for-machine-learning.zip

import pandas as pd

text = pd.read_csv('/content/data.csv')
text.head()
...
"""## **Set Variable Directory Pipeline**"""

PIPELINE_NAME = "hanifanta-pipeline"
SCHEMA_PIPELINE_NAME = "hanifanta-tfdv-schema"
...
text_df = pd.read_csv('/content/data/data.csv')
text_df.head()
    ...
    push_destination=pusher_pb2.PushDestination(
        filesystem=pusher_pb2.PushDestination.Filesystem(
            base_directory=os.path.join(
                SERVING_MODEL_DIR, "fake-news-model"
            ),
        )
    )
)
...
!zip -r /content/hanifanta-pipeline.zip /content/pipelines
